...
<body>
	<header id="header">
		<div class="hdTop">
			<div class="wid str">
				<h1>
					<a href="CinemaServlet?command=main_page" class="logo"><img
						src="images/header/logoRed.png" alt=""></a>
				</h1>
				<div class="topLink">
					<ul class="topLinkUl clear">
						<c:if test="${empty loginUser.id}">
							<li><a href="CinemaServlet?command=member_login"><span
									class="material-symbols-outlined">login</span><span
									class="spanTxt">로그인</span></a></li>
							<li><a href="CinemaServlet?command=member_join"><span
									class="material-symbols-outlined">person_add</span><span
									class="spanTxt">회원가입</span></a></li>
						</c:if>
						<c:if test="${!empty loginUser.id}">
							<tr>
								<li>반갑습니다${loginUser.name}(${loginUser.id})님</li>
								<li><a href="CinemaServlet?command=member_logout"><span
										class="material-symbols-outlined"> logout </span><span
										class="spanTxt">로그아웃</span></a></li>
								<li><a href="CinemaServlet?command=mypage_view"><span
										class="material-symbols-outlined">person</span><span
										class="spanTxt">MY CGV</span></a></li>
						</c:if>

						<li><a href="CinemaServlet?command=main_page"><span
								class="material-symbols-outlined">support_agent</span><span
								class="spanTxt">고객센터</span></a></li>
					</ul>
				</div>
					...
					<ul class="clear depth01">
						...
						<li><a href="CinemaServlet?command=main_page" data-text="예매"></a>
							<ul class="depth02">
								...
								<li><a href="CinemaServlet?command=main_page">English
										Ticketing</a></li>
								<li><a href="CinemaServlet?command=main_page">English
										Schedule</a></li>
							</ul></li>
