               ...
               <div class="row_group">
                  ...
                  <div class="join_row join_email">
                     ...
                     <input
                        ...
                        aria-label="선택입력" class="email" maxlength="100"> @ <select
                        type="text" id="email" name="email" class="email_line">
                           <option value selected>이메일 주소</option>
                           <option value="Na">naver.com</option>
                           <option value="Da">daum.net</option>
                           <option value="NT">nate.com</option>
                     </select>
                     </span>
                  </div>
               </div>
